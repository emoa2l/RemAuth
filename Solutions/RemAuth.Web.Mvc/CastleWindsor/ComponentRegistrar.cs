...
namespace RemAuth.Web.Mvc.CastleWindsor
{
    ...
    public class ComponentRegistrar
    {
        ...
        private static void AddTasksTo(IWindsorContainer container)
        {
            container.Register(
                AllTypes
                    .FromAssemblyNamed("RemAuth.Tasks")
                    .Pick()
                    .WithService.FirstNonGenericCoreInterface("RemAuth.Domain"));
        }
        ...
        private static void AddCustomRepositoriesTo(IWindsorContainer container) 
        {
            container.Register(
                AllTypes
                    .FromAssemblyNamed("RemAuth.Infrastructure")
                    .Pick()
                    .WithService.FirstNonGenericCoreInterface("RemAuth.Domain"));
        }
        ...
        {
            container.Register(
                AllTypes.FromAssemblyNamed("RemAuth.Web.Mvc")
                    .Pick()
        ...
        {
            container.Register(
                AllTypes.FromAssemblyNamed("RemAuth.Tasks")
                    .Pick()
                    .WithService.FirstInterface());
        }
    }
